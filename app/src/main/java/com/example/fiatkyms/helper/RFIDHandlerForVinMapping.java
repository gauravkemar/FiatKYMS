...
import com.example.fiatkyms.activity.VinRfidMappingActivity;
...
public class RFIDHandlerForVinMapping implements Readers.RFIDReaderEventHandler {
    ...
    private VinRfidMappingActivity context;
    // general
...
/*    public void init(ParkInActivity activity) {
        // application context
        context = activity;
        // Status UI
    ...
    public void init(VinRfidMappingActivity activity) {
        // application context
        context = activity;
        // Status UI
        //textView = activity.statusTextViewRFID;
